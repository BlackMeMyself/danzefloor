<div class="imagenfondo">
    <form id="sharesetform" enctype="multipart/form-data" method="POST">
...
<script>
    ...
    $(document).ready(function() {
        backurl.push("/shareset");
        $("#sharesetform").submit(function(ev) {
            var data = new FormData();
            $.each($("#file")[0].files, function(i, file) {
                data.append("music", file);
            });
            var otherData = $("#sharesetform").serializeArray();
